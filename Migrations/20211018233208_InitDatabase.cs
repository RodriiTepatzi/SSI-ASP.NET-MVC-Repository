    ...
    public partial class InitDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FixOrder_Picture", x => new { x.FixOrderId, x.PictureId });
                    table.ForeignKey(
                        name: "FK_FixOrder_Picture_FixOrders_FixOrderId",
                        column: x => x.FixOrderId,
                        principalTable: "FixOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FixOrder_Picture_Picture_PictureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FixOrder_Picture_PictureId",
                table: "FixOrder_Picture",
                column: "PictureId");
        }
